...
using Skuo.Account.Web.Areas.Account.Controllers.Models;
using Skuo.Identity;
using System;
...
using UserLoginInfo = Skuo.Account.Web.Areas.Account.Controllers.Models.UserLoginInfo;

namespace Skuo.Account.Web.Areas.Account.Controllers
{
