...
{
    public abstract class MongoUserRepositoryBase<TDbContext, TUser> : MongoDbRepository<TDbContext, TUser,long>, IUserRepository<TUser>
        ...
        where TUser : class, IUser
    {
        ...
        public virtual async Task<List<TUser>> GetListAsync(IEnumerable<long> ids, CancellationToken cancellationToken = default)
        {
