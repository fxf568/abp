...
namespace Skuo.PermissionManagement.Application.Tests.Skuo.PermissionManagement
{
    public class PermissionAppService_Tests : SkuoPermissionManagementApplicationTestBase
    {
