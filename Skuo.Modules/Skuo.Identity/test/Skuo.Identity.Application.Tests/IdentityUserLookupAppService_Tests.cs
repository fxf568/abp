...
{
    public class IdentityUserLookupAppService_Tests : SkuoIdentityApplicationTestBase
    {
        ...
        {
            var user = await _identityUserLookupAppService.FindByIdAsync(_idGenerator.NextId());
            user.ShouldBeNull();
        }
