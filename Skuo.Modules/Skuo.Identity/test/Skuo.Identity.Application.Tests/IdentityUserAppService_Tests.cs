...
{
    public class IdentityUserAppService_Tests : SkuoIdentityApplicationTestBase
    {
        ...
        public async Task CreateAsync()
        {
            ...
            result.Id.ShouldNotBe(_idGenerator.NextId());
        ...
        public async Task UpdateAsync_Concurrency_Exception()
        {
            ...
            (await Assert.ThrowsAsync<SkuoIdentityResultException>(async () =>
            {
                await _userAppService.UpdateAsync(johnNash.Id, input);
