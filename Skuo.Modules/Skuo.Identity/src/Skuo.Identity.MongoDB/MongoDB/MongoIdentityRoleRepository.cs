...
{
    public class MongoIdentityRoleRepository : MongoDbRepository<ISkuoIdentityMongoDbContext, IdentityRole, long>, IIdentityRoleRepository
    {
        public MongoIdentityRoleRepository(IMongoDbContextProvider<ISkuoIdentityMongoDbContext> dbContextProvider)
