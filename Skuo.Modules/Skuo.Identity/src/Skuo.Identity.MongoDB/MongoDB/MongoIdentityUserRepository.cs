...
{
    public class MongoIdentityUserRepository : MongoDbRepository<ISkuoIdentityMongoDbContext, IdentityUser, long>, IIdentityUserRepository
    {
        public MongoIdentityUserRepository(IMongoDbContextProvider<ISkuoIdentityMongoDbContext> dbContextProvider)
