...
{
    public class MongoIdentityClaimTypeRepository : MongoDbRepository<ISkuoIdentityMongoDbContext, IdentityClaimType, long>, IIdentityClaimTypeRepository
    {
        public MongoIdentityClaimTypeRepository(IMongoDbContextProvider<ISkuoIdentityMongoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
