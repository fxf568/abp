...
namespace Skuo.Identity
{
    public class IdentityUserAppService : IdentityAppServiceBase, IIdentityUserAppService
    {
        ...
        public virtual async Task<IdentityUserDto> GetAsync(long id)
        {
        ...
        [Authorize(IdentityPermissions.Users.Default)]
        public virtual async Task<ListResultDto<IdentityRoleDto>> GetRolesAsync(long id)
        {
        ...
        public virtual async Task<IdentityUserDto> UpdateAsync(long id, IdentityUserUpdateDto input)
        {
        ...
        {
            //框架current user id 使用了guid，这边统一调整为UserId
            if (this.UserId.GetValueOrDefault() == id)
            {
        ...
        [Authorize(IdentityPermissions.Users.Update)]
        public virtual async Task UpdateRolesAsync(long id, IdentityUserUpdateRolesDto input)
        {
            var user = await UserManager.GetByIdAsync(id);
