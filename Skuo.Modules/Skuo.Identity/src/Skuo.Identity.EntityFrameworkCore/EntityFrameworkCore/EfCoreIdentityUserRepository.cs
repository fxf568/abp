...
{
    public class EfCoreIdentityUserRepository : EfCoreRepository<IIdentityDbContext, IdentityUser, long>, IIdentityUserRepository
    {
        ...
        public virtual async Task<List<string>> GetRoleNamesAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var userRoles = DbContext.Set<IdentityUserRole>().ToList();
            var roels = DbContext.Roles.ToList();
