...
{
    public class IdentityUser : FullAuditedAggregateRoot<long>, IUser
    {
        ...
        public IdentityUser(long id, [NotNull] string userName, [NotNull] string email, Guid? tenantId = null)
        {
        ...
        public virtual void AddClaim([NotNull] IIdGenerator idGenerator, [NotNull] Claim claim)
        {
            ...
            Claims.Add(new IdentityUserClaim(idGenerator.NextId(), Id, claim, TenantId));
        }
