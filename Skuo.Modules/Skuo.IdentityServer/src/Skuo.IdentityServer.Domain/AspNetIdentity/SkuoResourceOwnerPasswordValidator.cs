...
{
    public class SkuoResourceOwnerPasswordValidator : IResourceOwnerPasswordValidator
    {
        ...
        protected IStringLocalizer<SkuoIdentityServerResource> Localizer { get; }

        public SkuoResourceOwnerPasswordValidator(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            IEventService events,
            ILogger<ResourceOwnerPasswordValidator<IdentityUser>> logger, 
            IStringLocalizer<SkuoIdentityServerResource> localizer)
        {
