...
namespace Skuo.IdentityServer.ApiResources
{
    ...
    {
        public virtual long ApiResourceId { get; protected set; }
        ...
        public virtual bool Equals(long apiResourceId, [NotNull] string value, string type = IdentityServerConstants.SecretTypes.SharedSecret)
        {
