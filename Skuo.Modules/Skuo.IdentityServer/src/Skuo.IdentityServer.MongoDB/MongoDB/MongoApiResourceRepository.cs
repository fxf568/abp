...
{
    public class MongoApiResourceRepository : MongoDbRepository<ISkuoIdentityServerMongoDbContext, ApiResource, long>, IApiResourceRepository
    {
        public MongoApiResourceRepository(IMongoDbContextProvider<ISkuoIdentityServerMongoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
