...
{
   public class EfCoreOrganizationRepository: EfCoreRepository<IOrganizationDbContext, OrganizationUnit, Guid>, IOrganizationRepository
    {
        public EfCoreOrganizationRepository(IDbContextProvider<IOrganizationDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }

        public Task<List<OrganizationUnit>> GetOrganizationsAsync(Guid userId)
        {
